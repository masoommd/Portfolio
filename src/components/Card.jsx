...
function Card({src,title, className='',path}) {
  return (
    <div className={`bg-gray-500 h-60 w-1/5 mr-4 border-2 border-slate-800 rounded-2xl p-2 hover:shadow-[0_8px_16px_rgba(0,9,0,0.8)] hover:bg-slate-400 ${className}`} key={title}>
      <Link to={path}>
